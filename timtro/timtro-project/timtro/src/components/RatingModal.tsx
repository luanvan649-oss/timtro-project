...
type Category = 'cleanliness' | 'communication' | 'respectfulness' | 'quietness' | 'reliability';
...
function RatingModal({ isOpen, onClose, roommate, onSubmit }: RatingModalProps) {
  ...
  const handleCategoryRating = (category: Category, value: number) => {
    setCategories(prev => ({
      ...prev,
      [category]: value
    }));
